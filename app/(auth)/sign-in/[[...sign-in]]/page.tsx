...
export default function SignInPage() {
  return (
    <div className="grid w-full grow items-center px-4 sm:justify-center min-h-screen  justify-center   bg-zinc-100             ">
      <SignIn.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                        ...
                        <Image src="/logo.png" alt="logo" width={100} height={100} className='m-auto' />
                  ...
                  <CardContent className="grid gap-y-4">
                    <div className="grid grid-cols-1 gap-x-4 justify-center items-center">
